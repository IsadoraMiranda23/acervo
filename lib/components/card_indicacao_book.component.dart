...
class CardIndicacaoBookComponent extends StatefulWidget {
  ...
  @override
  State<CardIndicacaoBookComponent> createState() =>
      _CardIndicacaoBookComponentState();
}

class _CardIndicacaoBookComponentState
    extends State<CardIndicacaoBookComponent> {
  @override
